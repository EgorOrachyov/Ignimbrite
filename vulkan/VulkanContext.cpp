...
void VulkanContext::_createTextureImage() {
    ...
    _transitionImageLayout(mTextureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
    _copyBufferToImage(stagingBuffer, mTextureImage, imageWidth, imageHeight);
    _transitionImageLayout(mTextureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
...
void VulkanContext::_createTextureSampler() {
...
void VulkanContext::_destroyTextureSampler() {
...
void VulkanContext::_copyBufferToImage(VkBuffer buffer, VkImage image, uint32 width, uint32 height) {
    VkCommandBuffer commandBuffer = _beginSingleTimeCommands();
...
VkCommandBuffer VulkanContext::_beginSingleTimeCommands() {
    VkCommandBufferAllocateInfo allocInfo = {};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
    allocInfo.commandPool = mCommandPool;
...
void VulkanContext::_endSingleTimeCommands(VkCommandBuffer commandBuffer) {
